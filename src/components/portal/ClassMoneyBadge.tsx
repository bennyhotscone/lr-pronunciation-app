...
export function ClassMoneyBadge({ balance }: { balance: number }) {
  return (
    <div
      className="mockup-chrome relative inline-block w-[11.5rem] shrink-0 overflow-hidden rounded-xl sm:w-[13rem]"
    ...
    >
      <img
        ...
        decoding="async"
      />
      <div className="absolute inset-[16%_18%_34%_18%] flex flex-col items-center justify-center rounded-md bg-[#f7f1df] text-center">
        <p className="text-[0.6rem] font-bold uppercase tracking-wide text-desk-accent">
          Class money
        </p>
