...
const ENGLISH_EXTRAS: Record<string, string[]> = {
  ...
  "father / dad": ["dad", "father", "daddy"],
  "mum / mom / mother": ["mum", "mom", "mother", "mummy", "mommy"],
  "mother / mum / mom": ["mum", "mom", "mother", "mummy", "mommy"],
  mum: ["mum", "mom", "mother", "mummy", "mommy"],
  mom: ["mum", "mom", "mother", "mummy", "mommy"],
  mother: ["mum", "mom", "mother", "mummy", "mommy"],
  "until now / so far": ["until now", "so far", "up to now", "ever"],
  "leave / separate": ["leave", "separate", "get away", "away"],
  "they / them": ["they", "them", "their"],
  "worry / concern": ["worry", "concern", "troubles"],
  "preparation / ready": ["preparation", "prepare", "ready", "prep"],
  "between / while": ["between", "while", "during"],
  "get used to": ["get used to", "used to", "accustomed"],
  "oneself / self": ["oneself", "self", "myself"],
  "seems / looks like": ["seems", "seem", "looks like", "appears"],
  "probably / I suppose": ["probably", "suppose", "i suppose", "I suppose"],
  "number one / most": ["number one", "most", "best", "number 1"],
  "thing / stuff": ["thing", "stuff", "things"],
  "choose / pick": ["choose", "pick", "select"],
  "a little / few": ["a little", "few", "a few", "little"],
  "teacher / Dr.": ["teacher", "dr", "doctor", "sensei"],
  "scary / afraid": ["scary", "afraid", "scared", "frightening"],
  "be in trouble": ["be in trouble", "trouble", "troubled", "in trouble"],
  "soon / right away": ["soon", "right away", "immediately", "right now"],
  "interesting / funny": ["interesting", "funny", "amusing"],
  "at least": ["at least", "least"],
  "mysterious / strange": ["mysterious", "strange", "wonder", "odd"],
  "ahead / first": ["ahead", "first", "beforehand"],
  "a lot / full": ["a lot", "full", "lots", "many"],
  "happy / glad": ["happy", "glad", "pleased"],
  "pretty / clean": ["pretty", "clean", "beautiful", "neat"],
  "action / behavior": ["action", "behavior", "behaviour", "act"],
  "freedom / free": ["freedom", "free"],
  "let's / shall we": ["lets", "let's", "shall we", "shall"],
  "that / its": ["that", "its", "the"],
  "kind / type": ["kind", "type", "sort"],
  "foot / leg": ["foot", "leg", "feet", "legs"],
  "any (whichever)": ["any", "whichever", "any of them"],
  "erase / turn off": ["erase", "turn off", "extinguish", "delete"],
  "because / from": ["because", "from", "since"],
  "hello / hi": ["hello", "hi", "hey"],
  "have to / gotta": ["have to", "gotta", "must", "need to"],
  "want to do": ["want to do", "wanna", "want to"],
  "want to meet": ["want to meet", "miss", "want to see"],
  "end / finish": ["end", "finish", "be over", "over"],
  "fuck / shit": ["fuck", "shit", "damn", "crap"],
  "damn / shit": ["fuck", "shit", "damn", "crap"],
  "damn it / fuck": ["damn it", "damn", "fuck", "shit", "crap"],
  damn: ["damn", "damn it", "fuck", "shit", "crap"],
  "hard / difficult": ["hard", "difficult", "tough"],
  difficult: ["hard", "difficult", "tough"],
  "pretty / quite": ["pretty", "quite", "fairly", "rather"],
  "much / many": ["much", "many", "a lot", "lots"],
  "too / also": ["too", "also"],
  "before / in front": ["before", "in front", "front"],
  OK: ["ok", "okay", "okee", "all right", "alright"],
};
